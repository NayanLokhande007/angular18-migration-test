...
@Component({
  selector: 'app-moderation-completed',
  standalone: true,
  imports: [CommonModule,ReactiveFormsModule],
  templateUrl: './moderation-completed.component.html',
  styleUrl: './moderation-completed.component.css'
})
export class ModerationCompletedComponent {
  ...
  getModeratedQue(){
    ...
    this.globalservice.getModeratedQue(this.emailid).subscribe(result => {
      const responsedata = JSON.parse(JSON.stringify(result));
      if (responsedata.status == 200) {
