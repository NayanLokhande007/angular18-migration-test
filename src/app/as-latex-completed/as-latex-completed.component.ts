...
@Component({
  selector: 'app-as-latex-completed',
  standalone: true,
  imports: [CommonModule,ReactiveFormsModule],
  templateUrl: './as-latex-completed.component.html',
  styleUrl: './as-latex-completed.component.css'
})
export class AsLatexCompletedComponent implements OnInit{
